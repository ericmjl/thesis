...
The HA and NA proteins, therefore, evolve under dual constraints: they have to continue functioning for cellular entry and release, while also evolve novel epitopes that can successfully evade immune system detection. This contributes to the greater diversity of HA and NA The internal proteins do not function under such selective pressures, and as such are 
