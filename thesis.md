...
The influenza A virus has a broad geographic and trophic range. Viral flow is canonically thought to start in the influenza A virus' reservoir hosts, wild ducks; wild duck migration patterns are strongly correlated with viral flow (#cite). Viruses can **spillover** from wild birds into domestic animals, such as pigs and chickens, sometimes causing pandemics (#chicken flu/swine flu). Because of the close proximity of humans to domestic animals, 
